...
Сайт разбит на 43 отдельных маршрута, объединённых в шесть групп:
...
1. **Part I · Workflow Engineering for ComfyUI** — Node Literacy, Graph Literacy, BASE CONFIG, control/data plane, switches/selectors/bypass, execution/queue/cache, LAB 01 Routing Sandbox, LAB 02 BASE CONFIG, LAB 03 Module Contract, modules, contracts, checkpoints и reproducibility.
