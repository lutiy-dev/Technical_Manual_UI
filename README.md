...
Сайт разбит на 40 отдельных маршрутов, объединённых в шесть групп:
...
1. **Part I · Workflow Engineering for ComfyUI** — Node Literacy, Graph Literacy, BASE CONFIG, control/data plane, switches/selectors/bypass, execution/queue/cache, modules, contracts, checkpoints и reproducibility.
